                        ...
                        <div class="users p-3">
                          <div class="list-users">
                            <div class="d-flex justify-content-between mb-2">
                              ...
                              <button type="button" class="btn btn-info btn-sm rounded-0" data-toggle="modal" data-target="#add-user-modal">
                                        ...
                                        <div class="form-group col-md-6">
                                          ...
                                          <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input male" value="1" name="gender">Nam
                                            </label>
                                          </div>
                                          <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input female" value="0" name="gender">Nữ
                                            </label>
                                          </div>
                                        </div>
